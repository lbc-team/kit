...
你可以在[此处阅读有关 Codecs 的更多信息](/docs/kit/docs/kit/docs/kit/docs/kit/docs/concepts/codecs)，但让我们快速了解如何创建一个 Codec 对象来解码我们的 `Mint` 账户。
...
如果您想更深入地了解 Kit 库，您可能会对文档的[核心概念](/docs/kit/docs/kit/docs/kit/docs/kit/docs/concepts)部分感兴趣。在那里，您将找到关于库的特定部分的深入文章，例如 [Codecs](/docs/kit/docs/kit/docs/kit/docs/kit/docs/concepts/codecs)、[Signers](/docs/kit/docs/kit/docs/kit/docs/kit/docs/concepts/signers) 和 [RPCs](/docs/kit/docs/kit/docs/kit/docs/kit/docs/concepts/rpc)。